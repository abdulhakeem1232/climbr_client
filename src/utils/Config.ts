...
const USER_API_GATEWAY_BASE_URL = 'https://climbrserver.site';
const RECRUITER_API_GATEWAY_BASE_URL = 'https://climbrserver.site/recruiter';
const ADMIN_API_GATEWAY_BASE_URL = 'https://climbrserver.site/admin';
